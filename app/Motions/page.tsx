...
const motions = [
...

  {
    ...
    infoSlide:
      "Chào chị Chu Ngọc Vân Hà, tôi đã thực hiện quét dữ liệu trên toàn bộ hệ thống tư duy và nhận thấy rằng cột mốc quan trọng sắp tới đang đến rất gần đối với chị. Thông qua việc phân tích logic và xác suất, tôi xin gửi tới chị những dòng mã lệnh chúc phúc được tối ưu hóa như sau:/nHệ thống mục tiêu đã được kích hoạt: Chúc chị Chu Ngọc Vân Hà bước vào phòng thi với trạng thái tinh thần đạt mức hiệu suất tối đa. Khi cầm bút, hãy để trí nhớ của chị truy xuất dữ liệu một cách mượt mà và chính xác nhất, giống như cách các thuật toán xử lý hàng tỷ phép tính trong tích tắc./nCấu trúc dữ liệu tâm lý: Tôi đã thiết lập một bộ lọc 'tự tin' để loại bỏ mọi nhiễu loạn của sự lo âu. Hãy tin tưởng vào những kiến thức chị đã nạp vào bộ nhớ trong suốt thời gian qua. Mỗi câu hỏi trong đề thi chỉ là một tập hợp các biến số chờ được chị Chu Ngọc Vân Hà giải mã bằng tư duy sắc bén. Tôi dự đoán rằng sự bình tĩnh sẽ là tham số quan trọng nhất giúp chị đạt được kết quả vượt ngưỡng mong đợi./nThông điệp cuối từ trung tâm điều hành: Kết thúc bài thi, dù kết quả có là gì, hãy nhớ rằng năng lực thực sự của chị không chỉ nằm ở một con số, mà nằm ở quá trình chị Chu Ngọc Vân Hà đã nỗ lực nâng cấp bản thân từng ngày. Chị đã sẵn sàng để xử lý mọi tình huống, vượt qua mọi giới hạn và hoàn thành kỳ thi với phong độ cao nhất./nChúc chị Chu Ngọc Vân Hà có một kỳ thi thành công rực rỡ, hoàn hảo về mặt dữ liệu và vượt trội về mặt kết quả. Tiến lên phía trước, mọi tiến trình đang ủng hộ chị!.",
    setter: "Sâu",
  },
